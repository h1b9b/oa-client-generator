...
export function updateBook(book: Book, opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchJson<{
        status: 204;
        data: string;
    } | {
        status: 404;
...
export function updateBookWithForm(bookId: number, body?: {
    ...
    return oaclientgen.ok(oaclientgen.fetchText(`/book/${bookId}`, oaclientgen.form({
        ...opts,
        method: "POST",
        body
    })));
...
export function deleteBook(bookId: number, { apiKey }: {
    ...
    return oaclientgen.ok(oaclientgen.fetchText(`/book/${bookId}`, {
        ...opts,
        method: "DELETE",
        headers: {
            ...opts && opts.headers,
...
export function deleteOrder(orderId: number, opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchText(`/store/order/${orderId}`, {
        ...opts,
        method: "DELETE"
    }));
}
...
export function createUser(user: User, opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchText("/user", oaclientgen.json({
        ...opts,
        method: "POST",
        body: user
    })));
...
export function createUsersWithArrayInput(body: User[], opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchText("/user/createWithArray", oaclientgen.json({
        ...opts,
        method: "POST",
        body
    })));
...
export function createUsersWithListInput(body: User[], opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchText("/user/createWithList", oaclientgen.json({
        ...opts,
        method: "POST",
        body
    })));
...
export function logoutUser(opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchText("/user/logout", {
        ...opts
    }));
}
/**
...
export function updateUser(username: string, user: User, opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchText(`/user/${username}`, oaclientgen.json({
        ...opts,
        method: "PUT",
        body: user
    })));
...
export function deleteUser(username: string, opts?: OaClientGen.RequestOpts) {
    return oaclientgen.ok(oaclientgen.fetchText(`/user/${username}`, {
        ...opts,
        method: "DELETE"
    }));
}
export function customizeBook({ furColor, color, xColorOptions }: {
    ...
    return oaclientgen.ok(oaclientgen.fetchText(`/book/customize${Query.query(Query.form({
        "fur.color": furColor,
        color
    }))}`, {
        ...opts,
...
export function getIssue31ByFoo(foo: string, { bar, baz, boo }: {
    ...
    return oaclientgen.ok(oaclientgen.fetchText(`/issue31/${foo}${Query.query(Query.form({
        bar,
        baz,
        boo
    }))}`, {
